 ...
 * so those tags cannot be populated from this file. Change both together.
 */
window.DFI_CONFIG = {
  siteTitle: 'Digital Futures Initiative',
  mission: 'Inspire. Teach. Empower.',
  siteUrl: 'https://dondie52.github.io/dfi/',
